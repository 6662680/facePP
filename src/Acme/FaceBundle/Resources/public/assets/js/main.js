    ...
    setImageFace: function( imageList )
    {
        ...
        $.each(imageList, function(key, item)
        {
            ...
            var faceTooltipWidth  = Math.ceil(imageWidth * (positoin.width / 100)),
                ...
                faceTooltipLeft   = Math.ceil(imageWidth * ((positoin.center.x /2) / 100) - positoin.center.x),
                faceTooltipTop    = Math.ceil(imageWidth * ((positoin.center.y / 2) / 100) / 2 - ( positoin.center.y / 2 ) ),
